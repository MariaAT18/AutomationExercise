...
Feature: Cart
  ...
  @EmptyMessage
  Scenario: The user should be able to see a correct message if he does not add products to the Cart
    Given the user is on the Products page and does not choose any product
    When the user goes to the Cart page using the Cart link
    Then the user should see a "Cart is empty!" message

  @Navigation
  Scenario: The user should be able to return to Products page from Shopping Cart if he does not have products added to the Cart
    Given the user is on the Products page and does not choose any product
    When the user goes to the Cart page using the Cart link
    Then the user should see a "Cart is empty!" message
    And the user goes to the Products page using the here link
    And the user should see the "All Products" title
